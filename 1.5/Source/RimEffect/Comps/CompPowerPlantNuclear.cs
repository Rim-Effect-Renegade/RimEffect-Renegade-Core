    ...
    public class CompPowerPlantNuclear : CompPowerTrader
    {
        ...
        public override void CompTick()
        {
            ...
            if (!noReactorRoom)
            {
                ...
                {
                    signalMeltdown = true;
                    this.parent.Map.weatherManager.curWeather = WeatherDef.Named("RE_RadioactiveFog");
                    this.parent.Map.weatherManager.TransitionTo(WeatherDef.Named("RE_RadioactiveFog"));
                    this.breakdownableComp.DoBreakdown();
        ...
        public override string CompInspectStringExtra()
        {
            ...
            else
            {
                ...
                {
                    stringBuilder.Append("RE_TempInReactorRoom".Translate(temperatureRightNow));
                }
                else stringBuilder.Append("RE_TempInReactorRoomCritical".Translate(temperatureRightNow));
